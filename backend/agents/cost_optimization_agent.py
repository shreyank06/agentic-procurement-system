"""
Cost Optimization Agent - LLM-powered agent for cost analysis.
...
class CostOptimizationAgent(BaseAgent):
    """LLM-powered agent for cost optimization analysis with semantic search."""
    ...
    def process(self, selected_item: Dict, request: Dict) -> Dict:
        """Main processing method for cost analysis.
        ...
        """
        return self.analyze_costs(selected_item, request)
